...
@testset "ComradeAdaptMCMC.jl" begin
    ...
    samples, endstate = sample(post, a1, 100_000; thin=5)
    samples, endstate = sample(post, a2, 100_000; thin=5)
    samples, endstate = sample(post, a1, 100_000; thin=5, init_params=x0)
