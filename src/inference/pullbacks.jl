function Comrade.make_pullback(ℓ, autodiff::AD.AbstractBackend)
    function ∇ℓ(x)
...
function Comrade.make_pullback(ℓ, ::AD.ReverseRuleConfigBackend)
    function ∇ℓ(x)
...
function Comrade.make_pullback(ℓ, autodiff::Function)
    function ∇ℓ(x)
