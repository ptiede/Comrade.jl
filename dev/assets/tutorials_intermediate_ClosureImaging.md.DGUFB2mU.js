import{_ as a,c as n,o as i,ai as p}from"./chunks/framework.DWHqByxi.js";const l="/Comrade.jl/dev/assets/ClosureImaging-42.Cu59UNbO.png",e="/Comrade.jl/dev/assets/ClosureImaging-44.DseO212d.png",t="/Comrade.jl/dev/assets/ClosureImaging-52.DdQYmwKH.png",h="/Comrade.jl/dev/assets/ClosureImaging-54.C3mDbmGz.png",u=JSON.parse('{"title":"Imaging a Black Hole using only Closure Quantities","description":"","frontmatter":{},"headers":[],"relativePath":"tutorials/intermediate/ClosureImaging.md","filePath":"tutorials/intermediate/ClosureImaging.md","lastUpdated":null}'),k={name:"tutorials/intermediate/ClosureImaging.md"};function r(d,s,c,o,g,E){return i(),n("div",null,s[0]||(s[0]=[p(`<h1 id="Imaging-a-Black-Hole-using-only-Closure-Quantities" tabindex="-1">Imaging a Black Hole using only Closure Quantities <a class="header-anchor" href="#Imaging-a-Black-Hole-using-only-Closure-Quantities" aria-label="Permalink to &quot;Imaging a Black Hole using only Closure Quantities {#Imaging-a-Black-Hole-using-only-Closure-Quantities}&quot;">​</a></h1><p>In this tutorial, we will create a preliminary reconstruction of the 2017 M87 data on April 6 using closure-only imaging. This tutorial is a general introduction to closure-only imaging in Comrade. For an introduction to simultaneous image and instrument modeling, see <a href="/Comrade.jl/dev/tutorials/intermediate/StokesIImaging#Stokes-I-Simultaneous-Image-and-Instrument-Modeling">Stokes I Simultaneous Image and Instrument Modeling</a></p><h2 id="Introduction-to-Closure-Imaging" tabindex="-1">Introduction to Closure Imaging <a class="header-anchor" href="#Introduction-to-Closure-Imaging" aria-label="Permalink to &quot;Introduction to Closure Imaging {#Introduction-to-Closure-Imaging}&quot;">​</a></h2><p>The EHT is one of the highest-resolution telescope ever created. Its resolution is equivalent to roughly tracking a hockey puck on the moon when viewing it from the earth. However, the EHT is also a unique interferometer. First, EHT data is incredibly sparse, the array is formed from only eight geographic locations around the planet. Second, the obseving frequency is much higher than traditional VLBI. Lastly, each site in the array is unique. They have different dishes, recievers, feeds, and electronics. Putting this all together implies that many of the common imaging techniques struggle to fit the EHT data and explore the uncertainty in both the image and instrument. One way to deal with some of these uncertainties is to not directly fit the data but instead fit closure quantities, which are independent of many of the instrumental effects that plague the data. The types of closure quantities are briefly described in <a href="/Comrade.jl/dev/vlbi_imaging_problem#Introduction-to-the-VLBI-Imaging-Problem">Introduction to the VLBI Imaging Problem</a>.</p><p>In this tutorial, we will do closure-only modeling of M87 to produce a posterior of images of M87.</p><p>To get started, we will load Comrade</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Comrade</span></span></code></pre></div><p>Pyehtim loads eht-imaging using PythonCall this is necessary to load uvfits files currently.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Pyehtim</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    CondaPkg Found dependencies: /home/runner/.julia/packages/DimensionalData/M9vEC/CondaPkg.toml</span></span>
...
<span class="line"><span>  + llvm-openmp            19.1.7  h024ca30_0             conda-forge     Cached</span></span>
<span class="line"><span>  + ld_impl_linux-64         2.43  h712a8e2_2             conda-forge     Cached</span></span>
<span class="line"><span>  + _openmp_mutex             4.5  2_kmp_llvm             conda-forge     Cached</span></span>
<span class="line"><span>  + libgcc                 14.2.0  h77fa898_1             conda-forge     Cached</span></span>
<span class="line"><span>  + liblzma                 5.6.4  hb9d3cd8_0             conda-forge     Cached</span></span>
<span class="line"><span>  + ncurses                   6.5  h2d0b736_3             conda-forge     Cached</span></span>
<span class="line"><span>  + libzlib                 1.3.1  hb9d3cd8_2             conda-forge     Cached</span></span>
<span class="line"><span>  + libffi                  3.4.6  h2dba641_0             conda-forge     Cached</span></span>
...
<span class="line"><span>  + openssl                3.0.16  h7b32b05_0             conda-forge     Cached</span></span>
<span class="line"><span>  + xz-tools                5.6.4  hb9d3cd8_0             conda-forge     Cached</span></span>
<span class="line"><span>  + xz-gpl-tools            5.6.4  hbcc6ac9_0             conda-forge     Cached</span></span>
<span class="line"><span>  + liblzma-devel           5.6.4  hb9d3cd8_0             conda-forge     Cached</span></span>
...
<span class="line"><span>  + uv                      0.6.0  h0f3a69f_0             conda-forge     Cached</span></span>
<span class="line"><span>  + libiconv                 1.17  hd590300_2             conda-forge     Cached</span></span>
...
<span class="line"><span>  + xz                      5.6.4  hbcc6ac9_0             conda-forge     Cached</span></span>
<span class="line"><span>  + libopenblas            0.3.28  pthreads_h94d23a6_1    conda-forge     Cached</span></span>
<span class="line"><span>  + libxml2                2.13.5  h0d44e9d_1             conda-forge     Cached</span></span>
<span class="line"><span>  + sqlite                 3.48.0  h9eae976_1             conda-forge     Cached</span></span>
<span class="line"><span>  + libhwloc               2.11.2  default_h0d58e46_1001  conda-forge     Cached</span></span>
<span class="line"><span>  + tbb                 2021.13.0  hceb3a55_1             conda-forge     Cached</span></span>
<span class="line"><span>  + mkl                  2024.2.2  ha957f24_16            conda-forge     Cached</span></span>
<span class="line"><span>  + libblas                 3.9.0  29_h59b9bed_openblas   conda-forge     Cached</span></span>
<span class="line"><span>  + libcblas                3.9.0  29_he106b2a_openblas   conda-forge     Cached</span></span>
<span class="line"><span>  + liblapack               3.9.0  29_h7ac8fdf_openblas   conda-forge     Cached</span></span>
<span class="line"><span>  + tzdata                  2025a  h78e105d_0             conda-forge     Cached</span></span>
...
<span class="line"><span>  + pip                    25.0.1  pyh8b19718_0           conda-forge     Cached</span></span>
...
<span class="line"><span>  + xarray               2024.3.0  pyhd8ed1ab_0           conda-forge     Cached</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  Summary:</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  Install: 50 packages</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>Linking llvm-openmp-19.1.7-h024ca30_0</span></span>
<span class="line"><span>Linking ld_impl_linux-64-2.43-h712a8e2_2</span></span>
<span class="line"><span>Linking _openmp_mutex-4.5-2_kmp_llvm</span></span>
<span class="line"><span>Linking libgcc-14.2.0-h77fa898_1</span></span>
<span class="line"><span>Linking liblzma-5.6.4-hb9d3cd8_0</span></span>
<span class="line"><span>Linking ncurses-6.5-h2d0b736_3</span></span>
<span class="line"><span>Linking libzlib-1.3.1-hb9d3cd8_2</span></span>
<span class="line"><span>Linking libffi-3.4.6-h2dba641_0</span></span>
...
<span class="line"><span>Linking openssl-3.0.16-h7b32b05_0</span></span>
<span class="line"><span>Linking xz-tools-5.6.4-hb9d3cd8_0</span></span>
<span class="line"><span>Linking xz-gpl-tools-5.6.4-hbcc6ac9_0</span></span>
<span class="line"><span>Linking liblzma-devel-5.6.4-hb9d3cd8_0</span></span>
...
<span class="line"><span>Linking uv-0.6.0-h0f3a69f_0</span></span>
<span class="line"><span>Linking libiconv-1.17-hd590300_2</span></span>
...
<span class="line"><span>Linking xz-5.6.4-hbcc6ac9_0</span></span>
<span class="line"><span>Linking libopenblas-0.3.28-pthreads_h94d23a6_1</span></span>
<span class="line"><span>Linking libxml2-2.13.5-h0d44e9d_1</span></span>
<span class="line"><span>Linking sqlite-3.48.0-h9eae976_1</span></span>
<span class="line"><span>Linking libhwloc-2.11.2-default_h0d58e46_1001</span></span>
<span class="line"><span>Linking tbb-2021.13.0-hceb3a55_1</span></span>
<span class="line"><span>Linking mkl-2024.2.2-ha957f24_16</span></span>
<span class="line"><span>Linking libblas-3.9.0-29_h59b9bed_openblas</span></span>
<span class="line"><span>Linking libcblas-3.9.0-29_he106b2a_openblas</span></span>
<span class="line"><span>Linking liblapack-3.9.0-29_h7ac8fdf_openblas</span></span>
<span class="line"><span>Linking tzdata-2025a-h78e105d_0</span></span>
...
<span class="line"><span>Linking pip-25.0.1-pyh8b19718_0</span></span>
...
<span class="line"><span>Linking xarray-2024.3.0-pyhd8ed1ab_0</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>Resolved 35 packages in 12ms</span></span>
<span class="line"><span>Installed 29 packages in 57ms</span></span>
<span class="line"><span> + astropy==6.1.7</span></span>
<span class="line"><span> + astropy-iers-data==0.2025.2.17.0.34.13</span></span>
...
<span class="line"><span> + ehtim==1.2.10</span></span>
...
<span class="line"><span> + kiwisolver==1.4.8</span></span>
<span class="line"><span> + matplotlib==3.10.0</span></span>
<span class="line"><span> + networkx==3.4.2</span></span>
<span class="line"><span> + pandas-appender==0.9.9</span></span>
<span class="line"><span> + paramsurvey==0.4.21</span></span>
<span class="line"><span> + pbr==6.1.1</span></span>
<span class="line"><span> + pillow==11.1.0</span></span>
<span class="line"><span> + psutil==7.0.0</span></span>
<span class="line"><span> + pyerfa==2.0.1.5</span></span>
<span class="line"><span> + pyparsing==3.2.1</span></span>
<span class="line"><span> + pyyaml==6.0.2</span></span>
<span class="line"><span> + requests==2.32.3</span></span>
<span class="line"><span> + scipy==1.15.2</span></span>
<span class="line"><span> + sgp4==2.24</span></span>
<span class="line"><span> + skyfield==1.50</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">skymeta </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (;mimg </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> imgpr</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">./</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">flux</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(imgpr));</span></span></code></pre></div><p>Now we can finally form our image prior. For this we use a heirarchical prior where the direct log-ratio image prior is a Gaussian Markov Random Field. The correlation length of the GMRF is a hyperparameter that is fit during imaging. We pass the data to the prior to estimate what the maximumal resolutoin of the array is and prevent the prior from allowing correlation lengths that are much small than the telescope beam size. Note that this GMRF prior has unit variance. For more information on the GMRF prior see the <a href="/Comrade.jl/dev/api#Comrade.corr_image_prior"><code>corr_image_prior</code></a> doc string.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">cprior </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> corr_image_prior</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(grid, dlcamp)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>HierarchicalPrior(</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">fig </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">|&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> DisplayAs</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">PNG </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">|&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> DisplayAs</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">Text</span></span></code></pre></div><p><img src="`+l+`" alt=""></p><p>Now let&#39;s plot the MAP estimate.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">g </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> imagepixels</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">μas2rad</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">150.0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">), </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">μas2rad</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">150.0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">), </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">100</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">100</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">fig </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">|&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> DisplayAs</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">PNG </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">|&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> DisplayAs</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">Text</span></span></code></pre></div><p><img src="`+t+`" alt=""></p><p>Now let&#39;s see whether our residuals look better.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">fig </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Figure</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(;size</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">800</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">300</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">))</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">fig </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">|&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> DisplayAs</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">PNG </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">|&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> DisplayAs</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">Text</span></span></code></pre></div><p><img src="`+h+'" alt=""></p><p>And viola, you have a quick and preliminary image of M87 fitting only closure products. For a publication-level version we would recommend</p><ol><li><p>Running the chain longer and multiple times to properly assess things like ESS and R̂ (see <a href="/Comrade.jl/dev/tutorials/beginner/GeometricModeling#Geometric-Modeling-of-EHT-Data">Geometric Modeling of EHT Data</a>)</p></li><li><p>Fitting gains. Typically gain amplitudes are good to 10-20% for the EHT not the infinite uncertainty closures implicitly assume</p></li></ol><hr><p><em>This page was generated using <a href="https://github.com/fredrikekre/Literate.jl" target="_blank" rel="noreferrer">Literate.jl</a>.</em></p>',81)]))}const m=a(k,[["render",r]]);export{u as __pageData,m as default};
